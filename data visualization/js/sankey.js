...
function getSankey() {
    ...
    var arrayCourse = ['16ws-04543','16-02938'];
    ...
    $(".content").prepend('<div id = "constraint-course-div" class="btn-group" role="group" aria-label="..."><button id = "add-course-button" class="btn btn-success" type="button" data-toggle="modal" data-target="#myModal">Add</button><button type="button" class="btn btn-default">16ws-02938 <span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button><button type="button" class="btn btn-default">16ws-30929 <span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button><button id = "refresh-course-button" class="btn btn-primary" type="button" >Refresh</button></div>');
...
//'https://raw.githubusercontent.com/Wizna/play/master/data.json'
    $.get('http://127.0.0.1:8000/sankey/?course='+courseList, function(pdata) {
