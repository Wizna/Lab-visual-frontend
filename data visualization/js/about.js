function getAbout() {
    ...
    // $(".content").append('<div id = "adddiv" style="width:50%;height:500px;float:right;text-align:left"><h1><a name="header-n0" class="md-header-anchor "></a>Lab : Data Analysis and visualization</h1><h3><a name="header-n2" class="md-header-anchor "></a>Brief</h3><p>This project is for the lab I&#39;ve taken this summer semester.</p><p>I finished 4 subtasks : course selection(Sankey), time &amp; performance(scatter), popular courses(word cloud), performance factors(3D bar)</p><h3><a name="header-n7" class="md-header-anchor "></a>Architecture</h3><p>MySQL - Django - Front end </p><h3><a name="header-n10" class="md-header-anchor "></a>Interesting</h3><p>Implemented a spell checker for German courses.</p><p></p><blockquote><p>All rights preserved - 黄锐铭</p></blockquote></div>')
