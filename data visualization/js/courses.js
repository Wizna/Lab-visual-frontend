...
function getCourses() {
    //resetting of style and remove useless divs
    $(".nav-tab").removeClass("active");
    $("#courses").addClass("active");
    $("#tab-plane").css("width", '100%');
    deleteUselessDivs();

    //data for 60 most popular courses of each month
    ...
    //use for getting data by index when setting color 
    var count = 0;
    var dlength = dataJan.length;

    //initial echart graph
                ...
                textStyle: {
                    normal: {
                        color: function() {
                            ...
                            //hash course name (string) to integer and then to RGB value
