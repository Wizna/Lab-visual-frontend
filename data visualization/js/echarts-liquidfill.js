        ...
        ([
                    ...
                    if (animationEnabled) {
                        ...
                        if (typeof animationDelay === 'function') {
                            animationDelay = animationDelay(
                                dataIndex,
                                animatableModel.getAnimationDelayParams ? animatableModel.getAnimationDelayParams(el, dataIndex) : null
                            );
                        }
            ...
            function(module, exports, __webpack_require__) {
                ...
                function createTrackClip(animator, easing, oneTrackDone, keyframes, propName) {
                    ...
                    var arrDim = (
                        isValueArray && isArrayLike(firstVal[0])
                    ) ? 2 : 1;
                    var trackMaxTime;
